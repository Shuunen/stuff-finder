...
export function AppItemDetails({ item }: Readonly<{ item: Item }>) {
  ...
  return (
    <div class="flex flex-col items-center sm:flex-row">
      <div class="absolute top-5 right-5 flex flex-col items-end gap-1 transition-opacity hover:opacity-85">
        <AppItemDetailsActions item={item} />
      </div>
      <div class="relative flex aspect-square w-full max-w-[40vh] min-w-40 flex-col md:max-w-72 md:min-w-64">
      ...
      <div class="mb-12 flex min-w-96 flex-col items-start justify-start gap-3 sm:mr-6 sm:mb-0">
        <h1>
        ...
        <div class="my-2 flex gap-3">
          ...
          <div class="font-medium">{itemLocation || 'Unknown'}</div>
        </div>
