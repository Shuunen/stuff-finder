...
window.customElements.define('app-settings-trigger', class extends HTMLElement {
  ...
  private wrapper = div('app-settings-trigger absolute top-5 right-5 h-10 w-10 cursor-pointer text-purple-400 transition-colors hover:text-purple-600', this.icon)
