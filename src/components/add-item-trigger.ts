...
window.customElements.define('app-add-item-trigger', class extends HTMLElement {
  ...
  icon = div('add-item hidden transition-colors text-purple-400 hover:text-purple-600 absolute top-5 right-32 -mt-0.5 mr-2 h-11 w-11 cursor-pointer', this.svg)
  connectedCallback () {
