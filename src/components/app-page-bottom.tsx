...
export function AppPageBottom ({ icon: Icon, nextLabel = 'Home', nextType = 'button', nextUrl = '/' }: { readonly icon: typeof DefaultIcon; readonly nextLabel?: string; readonly nextType?: 'button' | 'submit'; readonly nextUrl?: string }) {
  return (
