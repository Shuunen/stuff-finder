...
window.customElements.define('app-modal', class extends HTMLElement {
  ...
  private readonly backdrop = div('app-backdrop app-hide pointer-events-none fixed left-0 top-0 z-20 flex h-full w-full flex-col items-center justify-center bg-black/50 align-middle')
