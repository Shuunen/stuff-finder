...
export const itemForm = {
  ...
  fields: {
    ...
    box: createSelectField({ label: 'Box', options: optionsFor('boxes'), order: 80, regex: /^[\p{L}\s&()]{3,100}$/u }),
    ...
    drawer: createSelectField({ label: 'Drawer', options: optionsFor('drawers'), order: 90, regex: /\d/u }),
    ...
    photo: createTextField({ label: 'Photo', order: 95, regex: /^https?:\/\/\S+$/u }),
    price: createTextField({ label: 'Price', order: 110, regex: /^\d{1,5}$/u, unit: '€' }),
