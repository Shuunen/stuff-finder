...
it('gridClass G 7 columns', () => { expect(gridClass(7)).toBe('md:grid-cols-7') })
it('gridClass H 8 columns', () => { expect(gridClass(8)).toBe('md:grid-cols-8') })
it('gridClass I 9 columns', () => { expect(gridClass(9)).toBe('md:grid-cols-9') })
it('gridClass J 10 columns', () => { expect(gridClass(10)).toBe('md:grid-cols-10') })
...
it('colSpanClass G 7 columns', () => { expect(colSpanClass(7)).toBe('md:col-span-7') })
it('colSpanClass H 8 columns', () => { expect(colSpanClass(8)).toBe('md:col-span-8') })
it('colSpanClass I 9 columns', () => { expect(colSpanClass(9)).toBe('md:col-span-9') })
it('colSpanClass J 10 columns', () => { expect(colSpanClass(10)).toBe('md:col-span-10') })
