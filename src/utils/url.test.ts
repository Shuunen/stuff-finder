...
it('normalizePhotoUrl G', () => { expect(normalizePhotoUrl('https://m.media-amazon.com/images/I/41z6iny2jTL._SS142_.jpg')).toMatchInlineSnapshot('"https://m.media-amazon.com/images/I/41z6iny2jTL._SL500_.jpg"') })
it('normalizePhotoUrl H', () => { expect(normalizePhotoUrl('https://ae01.alicdn.com/kf/S8a947aca823d4f4e9b26cd232f319cc6i.jpg_220x220.jpg')).toMatchInlineSnapshot(`"https://ae01.alicdn.com/kf/S8a947aca823d4f4e9b26cd232f319cc6i.jpg_500x500q85.jpg"`) })
it('normalizePhotoUrl I', () => { expect(normalizePhotoUrl('https://ae-pic-a1.aliexpress-media.com/kf/S4c8a070043c446cca2f5ef55ba3962f8J.jpg_960x960q75.jpg_.avif')).toMatchInlineSnapshot(`"https://ae-pic-a1.aliexpress-media.com/kf/S4c8a070043c446cca2f5ef55ba3962f8J.jpg_500x500q85.jpg"`) })
