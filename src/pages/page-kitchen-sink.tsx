        ...
        {paletteRows.map(row => (
          <tr className="border-b border-grey/10" key={row.name}>
            <td className="w-16 py-2 pr-4">
              <div className="shadow-chunky-sm h-10 w-16 rounded border-2 border-grey" style={{ background: `var(${row.token})` }} />
            </td>
            <td className="py-2">
...
const typeScale = [
  ...
  // { label: 'h3 — Level three title', sample: 'Search across all your boxes and drawers.', tag: 'h3' },
  ...
  { label: 'small — Small text', sample: 'BRAND · LOCATION', tag: 'small' },
]
